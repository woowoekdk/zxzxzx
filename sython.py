...
@sython1.on(events.NewMessage(outgoing=False, pattern=r'^/point1 (.*)'))
async def OwnerStart(event):
...
@sython1.on(events.NewMessage(outgoing=False, pattern=r'^/point2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython1.on(events.NewMessage(outgoing=False, pattern=r'^/point3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython1.on(events.NewMessage(outgoing=False, pattern=r'^/point4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython2.on(events.NewMessage(outgoing=False, pattern=r'^/point1 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython2.on(events.NewMessage(outgoing=False, pattern=r'^/point2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython2.on(events.NewMessage(outgoing=False, pattern=r'^/point3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython2.on(events.NewMessage(outgoing=False, pattern=r'^/point4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython3.on(events.NewMessage(outgoing=False, pattern=r'^/point1 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython3.on(events.NewMessage(outgoing=False, pattern=r'^/point2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython3.on(events.NewMessage(outgoing=False, pattern=r'^/point3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython3.on(events.NewMessage(outgoing=False, pattern=r'^/point4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython4.on(events.NewMessage(outgoing=False, pattern=r'^/point1 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython4.on(events.NewMessage(outgoing=False, pattern=r'^/point2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython4.on(events.NewMessage(outgoing=False, pattern=r'^/point3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython4.on(events.NewMessage(outgoing=False, pattern=r'^/point4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython5.on(events.NewMessage(outgoing=False, pattern=r'^/point1 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython5.on(events.NewMessage(outgoing=False, pattern=r'^/point2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython5.on(events.NewMessage(outgoing=False, pattern=r'^/point3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
@sython5.on(events.NewMessage(outgoing=False, pattern=r'^/point4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
...
• @ZMMBOT - `/point1 + عدد النقاط `
• @A_MAN9300BOT - `/point2 + عدد النقاط`
• @MARKTEBOT - `/point3 + عدد النقاط `
• @XNSEX21BOT - `/point4 + عدد النقاط`**""")
